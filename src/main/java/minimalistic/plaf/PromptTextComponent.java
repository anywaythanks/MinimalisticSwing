...
import static swingTools.FontSizeCalculator.calculateStringMiddleYInContainer;
...
public class PromptTextComponent implements FocusListener {
    ...
    public PromptTextComponent(String prompt) {
        this(prompt, false);
    }
    ...
    public PromptTextComponent(String prompt, boolean hideOnFocus, Color colorPrompt) {
        this.prompt = prompt;
